...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_1_SurgDx_ICD9ICD10]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_1_SurgDx_ICD9ICD10    --altered (ORD_...Dflt)
...
SELECT distinct
	  ...
	  ,p.patientSSN
  into [MyDB].[MySchema].Lung_Sta3n528_2_Ex_1_SurgDx_ICD9ICD10    --altered (ORD_...Dflt)
  ...
  and (
	...
	or PrincipalPostOpICD10.ICD10Code in (select ICD10Code from [MyDB].[MySchema].Lung_Sta3n528_0_2_DxICD10CodeExc)    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_2_OutPatDx_ICD9ICD10]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_2_OutPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
SELECT 
	 [VDiagnosisSID]
	  ...
	  ,p.patientSSN 
into [MyDB].[MySchema].Lung_Sta3n528_2_Ex_2_OutPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
left join [MyDB].[MySchema].Lung_Sta3n528_0_4_DxICD9CodeExc as targetCode    --altered (ORD_...Dflt)
on targetCode.ICD9Code=DimICD9.ICD9Code
  left join CDWWork.Dim.ICD10 as DimICD10
  on Diag.ICD10SID=DimICD10.ICD10SID
left join [MyDB].[MySchema].Lung_Sta3n528_0_2_DxICD10CodeExc as ICD10CodeList										    --altered (ORD_...Dflt)
...
[VDiagnosisDateTime]> DATEADD(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))     --altered (ORD_...Dflt)
and [VDiagnosisDateTime]<= DATEADD(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10    --altered (ORD_...Dflt)
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Census501Diagnosis]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Census501Diagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Census501Diagnosis    --altered (ORD_...Dflt)
...
on ICD10CodeList.ICD10Code=DimICD10.ICD10Code
  ...
  on InpatDiag.sta3n=p.sta3n and InpatDiag.patientsid=p.patientsid
where --CohortName='Cohort20180712' and
	CensusDateTime>= DATEADD(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))	     --altered (ORD_...Dflt)
	and CensusDateTime<= DATEADD(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))     --altered (ORD_...Dflt)
and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)	
go

if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_CensusDiagnosis]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_CensusDiagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_CensusDiagnosis    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_Inpatient501TransactionDiagnosis]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_Inpatient501TransactionDiagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_Inpatient501TransactionDiagnosis    --altered (ORD_...Dflt)
...
on ICD10CodeList.ICD10Code=DimICD10.ICD10Code
  ...
  on InpatDiag.sta3n=p.sta3n and InpatDiag.patientsid=p.patientsid
where --CohortName='Cohort20180712' and
	SpecialtyTransferDateTime>= DATEADD(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))	     --altered (ORD_...Dflt)
	and SpecialtyTransferDateTime<= DATEADD(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))     --altered (ORD_...Dflt)
and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)	
go


if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_InpatientDischargeDiagnosis]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_InpatientDischargeDiagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_InpatientDischargeDiagnosis    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_PatientTransferDiagnosis]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_PatientTransferDiagnosis    --altered (ORD_...Dflt)
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_PatientTransferDiagnosis    --altered (ORD_...Dflt)
...
on ICD10CodeList.ICD10Code=DimICD10.ICD10Code
  ...
  on InpatDiag.sta3n=p.sta3n and InpatDiag.patientsid=p.patientsid
where --CohortName='Cohort20180712' and  
	PatientTransferDateTime>= DATEADD(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))	     --altered (ORD_...Dflt)
	and PatientTransferDateTime<= DATEADD(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))     --altered (ORD_...Dflt)
and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)	
go

if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_SpecialtyTransferDiagnosis]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_SpecialtyTransferDiagnosis    --altered (ORD_...Dflt)
SELECT 
...
,SpecialtyTransferDateTime as dx_dt
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_SpecialtyTransferDiagnosis    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_B_InpatientFeeDiagnosisDx_ICD9ICD10]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_B_InpatientFeeDiagnosisDx_ICD9ICD10    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type	  
	  ,p.patientSSN
into [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_B_InpatientFeeDiagnosisDx_ICD9ICD10    --altered (ORD_...Dflt)
...
-- Extract of all DX Codes for all potential patients from Purchased Care 
  		if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_2_Ex_3_C_FeeICDDxFromFeeServiceProvided_ICD9ICD10]') is not null)    --altered (ORD_...Dflt)
		drop table [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_C_FeeICDDxFromFeeServiceProvided_ICD9ICD10    --altered (ORD_...Dflt)
...
SELECT  
	...
	,d.InitialTreatmentDateTime as dx_dt
	  ...
	  ,targetCode.dx_code_type as ICD9dx_code_type
	   ,ICD10CodeList.ICD10Code as ICD10Code
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
into [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_C_FeeICDDxFromFeeServiceProvided_ICD9ICD10    --altered (ORD_...Dflt)
...
on ICD10CodeList.ICD10Code=DimICD10.ICD10Code
 ...
 InitialTreatmentDateTime> DATEADD(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))     --altered (ORD_...Dflt)
and d.InitialTreatmentDateTime<= DATEADD(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)
go
...
into [MyDB].[MySchema].Lung_Sta3n528_2_Ex_4_AllDx_ICD9    --altered (ORD_...Dflt)
 from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_2_OutPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
select patientSSN,sta3n,PatientSID,dx_dt,ICD9Code as ICD9,ICD9dx_code_type as dx_code_type,'Dx-InPat' as dataSource
 from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
select patientSSN,sta3n,PatientSID,dx_dt,ICD9Code,ICD9dx_code_type as dx_code_type,'Dx-InPatFee' as dataSource
 from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_B_InpatientFeeDiagnosisDx_ICD9ICD10    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
select patientSSN,sta3n,PatientSID,dx_dt,ICD9Code,ICD9dx_code_type as dx_code_type,'Dx-InPatFeeService' as dataSource
 from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_C_FeeICDDxFromFeeServiceProvided_ICD9ICD10    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
--
	UNION 
...
from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Census501Diagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_CensusDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_Inpatient501TransactionDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_InpatientDischargeDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_SpecialtyTransferDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_3_A_InPatDx_ICD9ICD10_PatientTransferDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
----------------
   Union
 ...
 from [MyDB].[MySchema].Lung_Sta3n528_2_Ex_1_SurgDx_ICD9ICD10 as a    --altered (ORD_...Dflt)
 ...
 where  isnull(PrincipalPostOpICD9Diagnosis,'') in (select ICD9Code from [MyDB].[MySchema].Lung_Sta3n528_0_4_DxICD9CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(OtherPostICD9Diagnosis,'') in (select ICD9Code from [MyDB].[MySchema].Lung_Sta3n528_0_4_DxICD9CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(assocDxICD9Diagnosis,'') in (select ICD9Code from [MyDB].[MySchema].Lung_Sta3n528_0_4_DxICD9CodeExc )    --altered (ORD_...Dflt)
 go
...
----------------
 ...
 where  isnull(PrincipalPostOpICD10Diagnosis,'') in (select ICD10Code from [MyDB].[MySchema].Lung_Sta3n528_0_2_DxICD10CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(OtherPostICD10Diagnosis,'') in (select ICD10Code from [MyDB].[MySchema].Lung_Sta3n528_0_2_DxICD10CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(assocDxICD10Diagnosis,'') in (select ICD10Code from [MyDB].[MySchema].Lung_Sta3n528_0_2_DxICD10CodeExc )    --altered (ORD_...Dflt)
 go
...
left join [MyDB].[MySchema].[Lung_Sta3n528_0_7_LungCancerDxICD9CodeExc] as CancerICD9CodeList    --altered (ORD_...Dflt)
on ICD9.ICD9Code=CancerICD9CodeList.ICD9Code
left join CDWWork.Dim.ICD10 as ICD10
  on Plist.ICD10SID=ICD10.ICD10SID
left join [MyDB].[MySchema].[Lung_Sta3n528_0_6_LungCancerDxICD10CodeExc] as CancerICD10CodeList    --altered (ORD_...Dflt)
on ICD10.ICD10Code=CancerICD10CodeList.ICD10Code
inner join [MyDB].[MySchema].[Lung_Sta3n528_1_In_8_IncPat] as p    --altered (ORD_...Dflt)
  on Plist.sta3n=p.sta3n and Plist.patientsid=p.patientsid
where --CohortName='Cohort20180712' and 
plist.RecordedDateTime >= DATEADD(yy,-1,(select sp_start from [MyDB].[MySchema].[Lung_Sta3n528_0_1_inputP]))     --altered (ORD_...Dflt)
and plist.RecordedDateTime <= DATEADD(dd,(select fu_period from [MyDB].[MySchema].[Lung_Sta3n528_0_1_inputP]),    --altered (ORD_...Dflt)
										(select sp_end from [MyDB].[MySchema].[Lung_Sta3n528_0_1_inputP]))    --altered (ORD_...Dflt)
and
(
...
-- Previous ICD procedures from inpatient tables 
				...
				if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc]') is not null)    --altered (ORD_...Dflt)
			drop table [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc			    --altered (ORD_...Dflt)
...
into [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
  FROM [CDWWork].[inpat].[InpatientICDProcedure] as ICDProc    --altered (ORD_...Src)
			  ...
			  left join [MyDB].[MySchema].Lung_Sta3n528_0_5_PreProcICD9ProcExc as TargetCode    --altered (ORD_...Dflt)
			  ...
			  on ICDProc.[ICD10ProcedureSID]=DimICD10Proc.[ICD10ProcedureSID]  
			    left join [MyDB].[MySchema].Lung_Sta3n528_0_3_PreProcICD10ProcExc as ICD10CodeList    --altered (ORD_...Dflt)
 ...
 where --CohortName='Cohort20180712' and
  ([ICDProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
  and [ICDProcedureDateTime]<= DateAdd(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
  )
 and (TargetCode.ICD9Proc_code_type is not null or ICD10CodeList.ICD10Proc_code_type is not null)	
 go


			if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_1_HLP_CensusICDProc_Inpat_ICD9ProcICD10Proc]') is not null)    --altered (ORD_...Dflt)
			drop table [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_1_HLP_CensusICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)

			 select pat.patientssn,ICDProc.sta3n,ICDProc.patientsid	,ICDProc.ICDProcedureDateTime
			  ,DimICD9Proc.[ICD9ProcedureCode],TargetCode.ICD9ProcCode,TargetCode.ICD9Proc_Code_Type
    			,DimICD10Proc.ICD10ProcedureCode,ICD10CodeList.ICD10ProcCode,ICD10CodeList.ICD10Proc_Code_Type
into [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_1_HLP_CensusICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_2_HLP_InPSurgICD_Inpat_ICD9ProcICD10Proc]') is not null)    --altered (ORD_...Dflt)
			drop table [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_2_HLP_InPSurgICD_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
...
into [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_2_HLP_InPSurgICD_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
 ...
 where --CohortName='Cohort20180712' and
  ([SurgicalProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
  and [SurgicalProcedureDateTime]<= DateAdd(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
  )
  and (TargetCode.ICD9Proc_code_type is not null or ICD10CodeList.ICD10Proc_code_type is not null)
go
...
if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_3_HLP_CensusSurgICD_Inpat_ICD9ProcICD10Proc]') is not null)    --altered (ORD_...Dflt)
			drop table [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_3_HLP_CensusSurgICD_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)

			 select pat.patientssn,a.sta3n,a.patientsid	,a.SurgicalProcedureDateTime
			  ,DimICD9Proc.[ICD9ProcedureCode],TargetCode.ICD9ProcCode,TargetCode.ICD9Proc_Code_Type
    			,DimICD10Proc.ICD10ProcedureCode,ICD10CodeList.ICD10ProcCode,ICD10CodeList.ICD10Proc_Code_Type
into [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_3_HLP_CensusSurgICD_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
...
go
	...
	if (OBJECT_ID('[MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_4_HLP_FeeICDProc_Inpat_ICD9ProcICD10Proc]') is not null)    --altered (ORD_...Dflt)
	drop table [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_4_HLP_FeeICDProc_Inpat_ICD9ProcICD10Proc	    --altered (ORD_...Dflt)

			 select pat.patientssn,a.sta3n,b.patientsid	,b.[TreatmentFromDateTime]
			  ,DimICD9Proc.[ICD9ProcedureCode],TargetCode.ICD9ProcCode,TargetCode.ICD9Proc_Code_Type
    			,DimICD10Proc.ICD10ProcedureCode,ICD10CodeList.ICD10ProcCode,ICD10CodeList.ICD10Proc_Code_Type
	into [MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_4_HLP_FeeICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
  ...
  ([TreatmentFromDateTime] >= DateAdd(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
  and [TreatmentFromDateTime]<= DateAdd(dd,(select fu_period from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP),(select sp_end from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
  )
   and (TargetCode.ICD9Proc_code_type is not null or ICD10CodeList.ICD10Proc_code_type is not null)
 go
...
if (OBJECT_ID('[MyDB].[MySchema].Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc') is not null)    --altered (ORD_...Dflt)
	...
	from [MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	...
	from [MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_1_HLP_CensusICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
	union
	select patientssn
      ,[sta3n]
	...
	from [MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_2_HLP_InPSurgICD_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
	union
	select patientssn
      ,[sta3n]
	...
	from [MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_3_HLP_CensusSurgICD_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
	union
	select patientssn
      ,[sta3n]
	 ...
	 from [MyDB].[MySchema].[Lung_Sta3n528_3_Exc_NonDx_3_PrevProc_4_HLP_FeeICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
...
where  --CPTProc.CohortName='Cohort20180712' and
	 CPTProc.[CPTProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
...
where 
	--VProc.CohortName='Cohort20180712' and
	 [VProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from [MyDB].[MySchema].Lung_Sta3n528_0_1_inputP))    --altered (ORD_...Dflt)
...
--  Red-flagged instances: Exclude patients with hospice/palliative care
	...
	from [MyDB].[MySchema].Lung_Sta3n528_3_Ins_3_Ex_Hospi_1_ByDx    --altered (ORD_...Dflt)
	except
	SELECT x.*
...
--  Red-flagged instances: Exclude patients with Inpatient hospice/palliative care
	...
	from [MyDB].[MySchema].Lung_Sta3n528_3_Ins_3_Ex_Hospi_2_Fee    --altered (ORD_...Dflt)
	except
	SELECT x.*
	 from [MyDB].[MySchema].Lung_Sta3n528_3_Ins_3_Ex_Hospi_2_Fee as x    --altered (ORD_...Dflt)
	 inner join [MyDB].[MySchema].Lung_Sta3n528_1_In_8_IncPat as p    --altered (ORD_...Dflt)
	 on  x.PatientSSN=p.PatientSSN
