--------------------------------------------
--- Lung Cancer Trigger 649b1ff				--1 parent bdffd7b  commit 649b1ff4c1c51a14599af4eb0a2d2e226b8a77ce
--------------------------------------------
...
--							select * from [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] 
...
--
--      8. Data Set		    
--			--#Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a		-- 	All chest images from sta6a in the study period
--			--#Lung_Sta3n671_1_In_3_RedFlagXRayCT				--  Abnormal (red_flagged) chest images from sta6a in the study period
--			--#Lung_Sta3n671_3_Ins_U_TriggerPos				--  Chest images from sta6a in the study period which come out trigger positive
--
--		9. If you want to delete the intermediate table generated during execution. uncomment the block at the end of the script.
--
--		10. Numerator and denumerators: select * from #Lung_Sta3n671_4_01_Count
...
set @sp_start='2020-12-01 00:00:00'
set @sp_end='2020-12-31 23:59:59' 
...
insert into  #Lung_Sta3n671_0_0_1_Sta3nSta6a (Sta3n,Sta6a)     --altered (ORD_...Dflt)
values 
 (
 --Set site(s) codes here. Keep only your site(s) uncommented.
 -- Cohort 1
-- 671,'671') --	(528A8) ALBANY,NY [7/1/00]
...
INSERT INTO [#Lung_Sta3n671_0_1_inputP]    --altered (ORD_...Dflt)
           ([trigger]
		   ,isVISN
		   ,isSta3n
		   ,[VISN]
...
select [trigger],ICD9Needed,run_dt,sp_start,sp_end,fu_period,age
 from [#Lung_Sta3n671_0_1_inputP]    --altered (ORD_...Dflt)

select * from #Lung_Sta3n671_0_0_1_Sta3nSta6a     --altered (ORD_...Dflt)


-- CPT Code lists for Lung images
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_0_2_0_LungImg') is not null) 		    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_0_2_0_LungImg    --altered (ORD_...Dflt)

	CREATE TABLE [#Lung_Sta3n671_0_2_0_LungImg] (    --altered (ORD_...Dflt)
...
insert into  #Lung_Sta3n671_0_2_0_LungImg ([img_code_type],[img_code_name],[ImgCode])     --altered (ORD_...Dflt)
values
( 'CT','','71275')
,( 'CT','','71250')
,( 'CT','','71270')
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_0_2_DxICD10CodeExc') is not null) 		    --altered (ORD_...Dflt)
	drop table [#Lung_Sta3n671_0_2_DxICD10CodeExc]    --altered (ORD_...Dflt)

	CREATE TABLE [#Lung_Sta3n671_0_2_DxICD10CodeExc] (    --altered (ORD_...Dflt)
	--UniqueID int Identity(1,1) not null,
...
insert into [#Lung_Sta3n671_0_2_DxICD10CodeExc] ([dx_code_type],	[dx_code_name] ,[ICD10Code])    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[tempdb.dbo.#Lung_Sta3n671_0_3_PreProcICD10ProcExc]') is not null) 		    --altered (ORD_...Dflt)
	...
	CREATE TABLE [#Lung_Sta3n671_0_3_PreProcICD10ProcExc] (    --altered (ORD_...Dflt)
	UniqueID int Identity(1,1) not null,
...
insert into [#Lung_Sta3n671_0_3_PreProcICD10ProcExc] ([ICD10Proc_code_type],	[ICD10Proc_code_Name] ,[ICD10ProcCode])    --altered (ORD_...Dflt)
...
insert into  [#Lung_Sta3n671_0_4_DxICD9CodeExc] (    --altered (ORD_...Dflt)
	[ICD9Code]
	) 
select distinct ICD9Code from CDWWork.dim.ICD9 as dimICD9
where (select ICD9Needed from #Lung_Sta3n671_0_1_inputP)=1    --altered (ORD_...Dflt)
...
update  [#Lung_Sta3n671_0_4_DxICD9CodeExc]     --altered (ORD_...Dflt)
...
If Exists (select ICD9Needed from #Lung_Sta3n671_0_1_inputP where ICD9Needed=1)    --altered (ORD_...Dflt)
	insert into  #Lung_Sta3n671_0_5_PreProcICD9ProcExc ([ICD9Proc_code_type],[ICD9Proc_code_Name],[ICD9ProcCode])     --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_0_6_LungCancerDxICD10CodeExc') is not null) 		    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_0_6_LungCancerDxICD10CodeExc    --altered (ORD_...Dflt)

	CREATE TABLE #Lung_Sta3n671_0_6_LungCancerDxICD10CodeExc (    --altered (ORD_...Dflt)
	UniqueID int Identity(1,1) not null,
	[dx_code_type] [varchar](50) NULL,
	[dx_code_name] [varchar](50) NULL,
	[ICD10Code] [varchar](10) NULL
...
insert into [#Lung_Sta3n671_0_6_LungCancerDxICD10CodeExc] ([dx_code_type],	[dx_code_name] ,[ICD10Code])    --altered (ORD_...Dflt)
...
insert into  #Lung_Sta3n671_0_7_LungCancerDxICD9CodeExc (    --altered (ORD_...Dflt)
[dx_code_type],
	[dx_code_name],
	[ICD9Code]
	) 
...
go
	...
	CREATE TABLE #Lung_Sta3n671_0_8_PrevProcCPTCodeExc (    --altered (ORD_...Dflt)
	UniqueID int Identity(1,1) not null,
...
insert into  #Lung_Sta3n671_0_8_PrevProcCPTCodeExc (    --altered (ORD_...Dflt)
	[CPT_code_type],
	[CPT_code_name] ,
	[CPTCode] 
	) 
...
go
	...
	CREATE TABLE #Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode (    --altered (ORD_...Dflt)
	UniqueID int Identity(1,1) not null,
	Sta3n smallint null,
...
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'POSSIBLE MALIGNANCY', 1, 800001068)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 800001096)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 800001097)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 800001098)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 800001113)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'HIGHLY SUGGESTIVE OF MALIGNANCY', 1, 800001142)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 800001146)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'POSSIBLE MALIGNANCY', 1, 800001883)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 800001904)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 800001905)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 800001906)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 800001921)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'LESION SUSPICIOUS FOR LUNG CA', 1, 800001925)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'ABNORMALITY: POSSIBLE MALIGNANCY, ATTN. NEEDED', 1, 800001928)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (691, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 800001933)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (644, N'PULMONARY NODULE PRESENT', 1, 800002109)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'HIGHLY SUG OF MALIG, TK ACTION', 1, 1000000002)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'SUSPICIOUS ABNORM, CONSIDER BX', 1, 1000000003)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (537, N'POSSIBLE MALIGNANCY', 1, 1000000340)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (537, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1000000361)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (537, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1000000362)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (537, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1000000363)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (537, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1000000378)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (537, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1000000416)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'POSSIBLE MALIGNANCY', 1, 1000000423)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1000000446)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1000000447)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1000000448)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'IMPORTANT REPORT/POSSIBLE MALIGNANCY', 1, 1000000462)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1000000463)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'POSSIBLE MALIGNANCY', 1, 1000000782)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'NEW UNSUSPECTED MALIGNANCY F/U ACTION NEEDED', 1, 1000000785)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1000000815)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1000000816)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1000000817)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1000000831)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'Suspicious for New Malignancy Need FU', 1, 1000000835)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1000000854)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'POSSIBLE MALIGNANCY', 1, 1000001015)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1000001036)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1000001037)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1000001038)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1000001053)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'CLINICAL ALERT-POSS. MALIGNANCY-E-MAIL', 1, 1000001064)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'CLINICAL ALERT-POSSIBLE MALIGNANCY', 1, 1000001069)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (589, N'POSSIBLE MALIGNACY, FOLLOW-UP NEEDED', 1, 1000001073)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'POSSIBLE MALIGNANCY', 1, 1000001552)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'SUSPICIOUS FOR MALIGNANCY-CLINICAL FOLLOW-UP ACTION NEEDED', 1, 1000001555)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1000001583)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1000001584)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1000001585)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1000001600)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'Suspicious for New Malignancy Need FU ', 1, 1000001605)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'PULMONARY EMBOLISM, IMMEDIATE ATTN NEEDED', 1, 1000001615)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'PULMONARY EMBOLISM, IMMEDIATE ATTN NEEDED', 1, 1000001617)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'NODULES 4mm TO LESS THAN 2cm', 1, 1000001619)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'NODULES/MASSES GREATER THAN 2cm', 1, 1000001620)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1000001628)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (671, N'POSSIBLE MALIGNANCY', 1, 1000002243)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (671, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1000002263)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (671, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1000002264)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (671, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1000002265)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (671, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1000002279)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (671, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1000002307)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'NODULES LESS THAN 6 MM', 1, 1000002593)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (635, N'NODULES 6MM TO LESS THEN 2CM', 1, 1000002594)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'POSSIBLE MALIGNANCY', 1, 1200000692)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'MASS LESION', 1, 1200000694)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1200000698)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'LUNG - SUSPICION FOR CANCER', 1, 1200000722)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1200000727)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1200000728)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1200000729)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1200000745)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1200000747)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (541, N'LUNG MASS-IMMEDIATE ATTENTION NEEDED.', 1, 1200000753)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (512, N'POSSIBLE MALIGNANCY', 1, 1400000304)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (512, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1400000317)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (512, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1400000325)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (512, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1400000326)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (512, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1400000327)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (512, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1400000342)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'POSSIBLE MALIGNANCY', 1, 1400000451)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1400000472)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1400000473)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1400000474)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1400000489)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'POSSIBLE MALIGNANCY, FOLLOW-UP NEEDED', 1, 1400000495)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'Possible Malignancy', 1, 1400000529)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'Lung Lesion for follow-up team', 1, 1400000530)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'Possible Malignancy ', 1, 1400000537)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'Lung lesion for follow up team', 1, 1400000538)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (523, N'LUNG NODULE FOLLOW UP', 1, 1400000540)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'POSSIBLE MALIGNANCY', 1, 1400000629)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1400000650)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1400000651)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1400000652)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1400000667)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'SUSPICIOUS FINDINGS,FU STUDY RECOM', 1, 1400000669)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'POSS PROBABLE TUMOR, PROVIDER NOTIFIED', 1, 1400000672)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'CATEGORY 5 HIGHLY SUGG MALIGNANCY', 1, 1400000688)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (528, N'POSSIBLE MALIGNANCY, FOLLOWUP NEEDED', 1, 1400000716)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (540, N'POSSIBLE MALIGNANCY', 1, 1400000805)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (540, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1400000824)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (540, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1400000825)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (540, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1400000826)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (540, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1400000840)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (540, N'POSS MALIGN, F/U NEEDED, ALERT SENT    ', 1, 1400000843)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (642, N'POSSIBLE MALIGNANCY', 1, 1400001450)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (642, N'LUNGRADS 4A: SUSPICIOUS NODULE', 1, 1400001471)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (642, N'LUNGRADS 4B: SUSPICIOUS NODULE', 1, 1400001472)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (642, N'LUNGRADS 4X: SUSPICIOUS NODULE WITH ADDITIONAL FEATURES', 1, 1400001473)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (642, N'INCIDENTAL LUNG NODULE(NONSCREENING)', 1, 1400001488)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (642, N'MAJOR ABNORMALITY/POSSIBLE MALIGNANCY', 1, 1400002196)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'SOLID MASS, IRREGULAR MARGINS', 1, 1000000476)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (549, N'NEW LESIONS, ATTN. NEEDED', 1, 1000000466)    --altered (ORD_...Dflt)
GO
INSERT [#Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode] ([sta3n], [RadiologyDiagnosticCode], [isRedFlag], [RadiologyDiagnosticCodeSID]) VALUES (580, N'POSSIBLE NEW LUNG CANCER', 1, 1000002624)    --altered (ORD_...Dflt)
GO
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET    --altered (ORD_...Dflt)
...
into #Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET     --altered (ORD_...Dflt)
FROM [CDWWork].[Rad].[RadiologyExam] as Rad    --altered (ORD_...Src)
--NeedToSwitch
inner join [#Lung_Sta3n671_0_0_1_Sta3nSta6a] as s    --altered (ORD_...Dflt)
...
inner join  #Lung_Sta3n671_0_2_0_LungImg as TargetImg    --altered (ORD_...Dflt)
...
on Rad.sta3n=diag.sta3n and Rad.[RadiologyDiagnosticCodeSID]=diag.[RadiologyDiagnosticCodeSID]
  ...
  where --Rad.CohortName='Cohort20180712' and
	 Rad.ExamDateTime
	  between (select sp_start from #Lung_Sta3n671_0_1_inputP)     --altered (ORD_...Dflt)
	  and DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP)) --Clue Date Range+followup    --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN    --altered (ORD_...Dflt)
;
	select distinct b.patientSSN,convert(varchar(10),b.BirthDateTime,120) as DOB,convert(varchar(10),b.DeathDateTime,120) as DOD,b.Gender as Sex
				,a.* 	
	into #Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN    --altered (ORD_...Dflt)
	from #Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET as a    --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a    --altered (ORD_...Dflt)
;
select Rad.* into #Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN] as Rad    --altered (ORD_...Dflt)
	--NeedToSwitch
	inner join [#Lung_Sta3n671_0_0_1_Sta3nSta6a] as s    --altered (ORD_...Dflt)
...
where [img_code_type] in ('CT','XRay')
	and ExamDateTime
	  between (select sp_start from #Lung_Sta3n671_0_1_inputP)     --altered (ORD_...Dflt)
	  and (select sp_end from #Lung_Sta3n671_0_1_inputP)     --altered (ORD_...Dflt)

go


-- Chest_XRay/CT images that are flagged during study period from your site 
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_1_In_3_RedFlagXRayCT') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_1_In_3_RedFlagXRayCT    --altered (ORD_...Dflt)
;
select  Rad.* into #Lung_Sta3n671_1_In_3_RedFlagXRayCT    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a] as Rad    --altered (ORD_...Dflt)
--NeedToSwitch
inner join #Lung_Sta3n671_0_A_RedFlagXRayCTDiagnosticCode as code    --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_1_In_6_IncIns') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_1_In_6_IncIns    --altered (ORD_...Dflt)
;
select 	distinct
		[RadiologyExamSID]
	  ,PatientSSN
	  ...
	  ,DOD
	  ,Sex
into #Lung_Sta3n671_1_In_6_IncIns    --altered (ORD_...Dflt)
from #Lung_Sta3n671_1_In_3_RedFlagXRayCT as Rad    --altered (ORD_...Dflt)
where ExamDateTime between (select sp_start from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
				and (select sp_end from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
...
-- Get other possible patientSID outside your sta3n
 if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_1_In_8_IncPat') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_1_In_8_IncPat    --altered (ORD_...Dflt)

select VStatus.Sta3n,VStatus.PatientSID,VStatus.patientSSN, VStatus.ScrSSN,VStatus.PatientICN			--removed distinct
into #Lung_Sta3n671_1_In_8_IncPat    --altered (ORD_...Dflt)
from #Lung_Sta3n671_1_In_6_IncIns as a    --altered (ORD_...Dflt)
...
SELECT distinct
	  ...
	  ,p.patientSSN
  into #Lung_Sta3n671_2_Ex_1_SurgDx_ICD9ICD10    --altered (ORD_...Dflt)
  FROM [CDWWork].[Surg].[SurgeryPre] as surgPre    --altered (ORD_...Src)
  inner join #Lung_Sta3n671_1_In_8_IncPat as p    --altered (ORD_...Dflt)
  ...
  on assocDx.[SurgeryPrincipalAssociatedDiagnosisICD10SID]=assocDxICD10.ICD10SID and assocDx.sta3n=assocDxICD10.sta3n
   where  
  SurgPre.[SurgeryDateTime]>= DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))  and    --altered (ORD_...Dflt)
  SurgPre.[SurgeryDateTime]<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  ...
  and (
  	--PreICD9.ICD9Code in (select ICD9Code from [#Lung_Sta3n671_0_4_DxICD9CodeExc])    --altered (ORD_...Dflt)
	PrincipalPostOpICD9.ICD9Code in (select ICD9Code from [#Lung_Sta3n671_0_4_DxICD9CodeExc])    --altered (ORD_...Dflt)
	or 	OtherPostICD9.ICD9Code in (select ICD9Code from [#Lung_Sta3n671_0_4_DxICD9CodeExc])    --altered (ORD_...Dflt)
	or 	assocDxICD9.ICD9Code in (select ICD9Code from [#Lung_Sta3n671_0_4_DxICD9CodeExc])    --altered (ORD_...Dflt)

	or PrincipalPostOpICD10.ICD10Code in (select ICD10Code from #Lung_Sta3n671_0_2_DxICD10CodeExc)    --altered (ORD_...Dflt)
	or 	OtherPostICD10.ICD10Code in (select ICD10Code from #Lung_Sta3n671_0_2_DxICD10CodeExc)    --altered (ORD_...Dflt)
	or 	assocDxICD10.ICD10Code in (select ICD10Code from #Lung_Sta3n671_0_2_DxICD10CodeExc)    --altered (ORD_...Dflt)
...
SELECT 
	 [VDiagnosisSID]
	  ...
	  ,p.patientSSN 
into #Lung_Sta3n671_2_Ex_2_OutPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
left join #Lung_Sta3n671_0_4_DxICD9CodeExc as targetCode    --altered (ORD_...Dflt)
on targetCode.ICD9Code=DimICD9.ICD9Code
  left join CDWWork.Dim.ICD10 as DimICD10
  on Diag.ICD10SID=DimICD10.ICD10SID
left join #Lung_Sta3n671_0_2_DxICD10CodeExc as ICD10CodeList										    --altered (ORD_...Dflt)
...
[VDiagnosisDateTime]> DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
and [VDiagnosisDateTime]<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),    --altered (ORD_...Dflt)
										(select sp_end from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN
	into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
on ICD10CodeList.ICD10Code=DimICD10.ICD10Code
  ...
  [DischargeDateTime]> DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
and [DischargeDateTime]<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)
	go
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_Census501Diagnosis    --altered (ORD_...Dflt)
...
inner join [#Lung_Sta3n671_1_In_8_IncPat] as p    --altered (ORD_...Dflt)
		on InpatDiag.sta3n=p.sta3n and InpatDiag.patientsid=p.patientsid
where --CohortName='Cohort20180712' and
	CensusDateTime>= DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))	     --altered (ORD_...Dflt)
	and CensusDateTime<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
	and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)	
go
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_CensusDiagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_Inpatient501TransactionDiagnosis    --altered (ORD_...Dflt)
...
inner join [#Lung_Sta3n671_1_In_8_IncPat] as p    --altered (ORD_...Dflt)
		on InpatDiag.sta3n=p.sta3n and InpatDiag.patientsid=p.patientsid
where --CohortName='Cohort20180712' and
	SpecialtyTransferDateTime>= DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))	     --altered (ORD_...Dflt)
	and SpecialtyTransferDateTime<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
	and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)	
AND InpatDiag.Sta3n=671 
go
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_InpatientDischargeDiagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_PatientTransferDiagnosis    --altered (ORD_...Dflt)
...
inner join [#Lung_Sta3n671_1_In_8_IncPat] as p    --altered (ORD_...Dflt)
		on InpatDiag.sta3n=p.sta3n and InpatDiag.patientsid=p.patientsid
where --CohortName='Cohort20180712' and  
	PatientTransferDateTime>= DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))	     --altered (ORD_...Dflt)
	and PatientTransferDateTime<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
	and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)	
AND InpatDiag.Sta3n=671
go
...
,SpecialtyTransferDateTime as dx_dt
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
	  ,p.patientSSN	  
	into  #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_SpecialtyTransferDiagnosis    --altered (ORD_...Dflt)
...
SELECT 
	  ...
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type	  
	  ,p.patientSSN
into #Lung_Sta3n671_2_Ex_3_B_InpatientFeeDiagnosisDx_ICD9ICD10    --altered (ORD_...Dflt)
...
SELECT  
	...
	,d.InitialTreatmentDateTime as dx_dt
	  ...
	  ,targetCode.dx_code_type as ICD9dx_code_type
	   ,ICD10CodeList.ICD10Code as ICD10Code
	  ,ICD10CodeList.dx_code_type as ICD10dx_code_type
into #Lung_Sta3n671_2_Ex_3_C_FeeICDDxFromFeeServiceProvided_ICD9ICD10    --altered (ORD_...Dflt)
...
left join #Lung_Sta3n671_0_2_DxICD10CodeExc as ICD10CodeList										    --altered (ORD_...Dflt)
on ICD10CodeList.ICD10Code=DimICD10.ICD10Code
  inner join [#Lung_Sta3n671_1_In_8_IncPat] as c    --altered (ORD_...Dflt)
  on a.sta3n=c.sta3n and a.patientsid=c.patientsid
  where --a.CohortName='Cohort20180712'  and d.CohortName='Cohort20180712' and
 
 InitialTreatmentDateTime> DATEADD(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))     --altered (ORD_...Dflt)
and d.InitialTreatmentDateTime<= DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
and (TargetCode.dx_code_type is not null or ICD10CodeList.dx_code_type is not null)
go
...
into #Lung_Sta3n671_2_Ex_4_AllDx_ICD9    --altered (ORD_...Dflt)
 from #Lung_Sta3n671_2_Ex_2_OutPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
select patientSSN,sta3n,PatientSID,dx_dt,ICD9Code as ICD9,ICD9dx_code_type as dx_code_type,'Dx-InPat' as dataSource
 from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
select patientSSN,sta3n,PatientSID,dx_dt,ICD9Code,ICD9dx_code_type as dx_code_type,'Dx-InPatFee' as dataSource
 from #Lung_Sta3n671_2_Ex_3_B_InpatientFeeDiagnosisDx_ICD9ICD10    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
select patientSSN,sta3n,PatientSID,dx_dt,ICD9Code,ICD9dx_code_type as dx_code_type,'Dx-InPatFeeService' as dataSource
 from #Lung_Sta3n671_2_Ex_3_C_FeeICDDxFromFeeServiceProvided_ICD9ICD10    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
--
	UNION 
...
from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_Census501Diagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_CensusDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_Inpat_Inpatient501TransactionDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_InpatientDischargeDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_SpecialtyTransferDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
	UNION 
...
from #Lung_Sta3n671_2_Ex_3_A_InPatDx_ICD9ICD10_PatientTransferDiagnosis    --altered (ORD_...Dflt)
where ICD9dx_code_type is not null
----------------
   Union
 ...
 from #Lung_Sta3n671_2_Ex_1_SurgDx_ICD9ICD10 as a    --altered (ORD_...Dflt)
 inner join #Lung_Sta3n671_0_4_DxICD9CodeExc  as b    --altered (ORD_...Dflt)
 on a.PrincipalPostOpICD9Diagnosis=b.ICD9Code
 where  isnull(PrincipalPostOpICD9Diagnosis,'') in (select ICD9Code from #Lung_Sta3n671_0_4_DxICD9CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(OtherPostICD9Diagnosis,'') in (select ICD9Code from #Lung_Sta3n671_0_4_DxICD9CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(assocDxICD9Diagnosis,'') in (select ICD9Code from #Lung_Sta3n671_0_4_DxICD9CodeExc )    --altered (ORD_...Dflt)
 go
...
into #Lung_Sta3n671_2_Ex_4_AllDx_ICD10    --altered (ORD_...Dflt)
 from #Lung_Sta3n671_2_Ex_2_OutPatDx_ICD9ICD10    --altered (ORD_...Dflt)
...
----------------
 ...
 select patientSSN,sta3n, PatientSID,dx_dt,PrincipalPostOpICD10Diagnosis as ICD10
		...
		,'Dx-Surg' as dataSource
 from #Lung_Sta3n671_2_Ex_1_SurgDx_ICD9ICD10 as a    --altered (ORD_...Dflt)
 inner join #Lung_Sta3n671_0_2_DxICD10CodeExc  as b    --altered (ORD_...Dflt)
 on a.PrincipalPostOpICD10Diagnosis=b.ICD10Code
 where  isnull(PrincipalPostOpICD10Diagnosis,'') in (select ICD10Code from #Lung_Sta3n671_0_2_DxICD10CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(OtherPostICD10Diagnosis,'') in (select ICD10Code from #Lung_Sta3n671_0_2_DxICD10CodeExc )    --altered (ORD_...Dflt)
   Union
 ...
 where  isnull(assocDxICD10Diagnosis,'') in (select ICD10Code from #Lung_Sta3n671_0_2_DxICD10CodeExc )    --altered (ORD_...Dflt)
 go
...
into [#Lung_Sta3n671_2_Ex_4_UnionAllDx_ICD9ICD10]    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_2_Ex_4_AllDx_ICD9]    --altered (ORD_...Dflt)
Union ALL
select patientSSN,Sta3n,PatientSID,dx_dt,ICD10,dataSource,dx_code_type
from [#Lung_Sta3n671_2_Ex_4_AllDx_ICD10]    --altered (ORD_...Dflt)
go
...
into #Lung_Sta3n671_2_Ex_7_ProblemListLC_Dx_ICD9ICD10    --altered (ORD_...Dflt)
 FROM [CDWWork].[Outpat].[ProblemList] as Plist    --altered (ORD_...Src)
left join CDWWork.Dim.ICD9 as ICD9
  on Plist.ICD9SID=ICD9.ICD9SID
left join [#Lung_Sta3n671_0_7_LungCancerDxICD9CodeExc] as CancerICD9CodeList    --altered (ORD_...Dflt)
on ICD9.ICD9Code=CancerICD9CodeList.ICD9Code
left join CDWWork.Dim.ICD10 as ICD10
  on Plist.ICD10SID=ICD10.ICD10SID
left join [#Lung_Sta3n671_0_6_LungCancerDxICD10CodeExc] as CancerICD10CodeList    --altered (ORD_...Dflt)
on ICD10.ICD10Code=CancerICD10CodeList.ICD10Code
inner join [#Lung_Sta3n671_1_In_8_IncPat] as p    --altered (ORD_...Dflt)
  on Plist.sta3n=p.sta3n and Plist.patientsid=p.patientsid
where --CohortName='Cohort20180712' and 
plist.RecordedDateTime >= DATEADD(yy,-1,(select sp_start from [#Lung_Sta3n671_0_1_inputP]))     --altered (ORD_...Dflt)
and plist.RecordedDateTime <= DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP]),    --altered (ORD_...Dflt)
										(select sp_end from [#Lung_Sta3n671_0_1_inputP]))    --altered (ORD_...Dflt)
and
(
...
into #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
  FROM [CDWWork].[inpat].[InpatientICDProcedure] as ICDProc    --altered (ORD_...Src)
			  ...
			  left join #Lung_Sta3n671_0_5_PreProcICD9ProcExc as TargetCode    --altered (ORD_...Dflt)
			  ...
			  on ICDProc.[ICD10ProcedureSID]=DimICD10Proc.[ICD10ProcedureSID]  
			    left join #Lung_Sta3n671_0_3_PreProcICD10ProcExc as ICD10CodeList    --altered (ORD_...Dflt)
			  on DimICD10Proc.ICD10ProcedureCode=ICD10CodeList.ICD10ProcCode  
  inner join (select distinct ScrSSN,patientSSN,patientICN,sta3n,patientsid from [#Lung_Sta3n671_1_In_8_IncPat]) as pat    --altered (ORD_...Dflt)
  on ICDProc.patientsid=pat.patientsid and ICDProc.sta3n=pat.sta3n
 where --CohortName='Cohort20180712' and
  ([ICDProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  and [ICDProcedureDateTime]<= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  )
...
select pat.patientssn,ICDProc.sta3n,ICDProc.patientsid	,ICDProc.ICDProcedureDateTime
			  ,DimICD9Proc.[ICD9ProcedureCode],TargetCode.ICD9ProcCode,TargetCode.ICD9Proc_Code_Type
    			,DimICD10Proc.ICD10ProcedureCode,ICD10CodeList.ICD10ProcCode,ICD10CodeList.ICD10Proc_Code_Type
into #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_1_HLP_CensusICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
...
into #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_2_HLP_InPSurgICD_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
FROM [CDWWork].[inpat].[InpatientSurgicalProcedure] as a    --altered (ORD_...Src)
 ...
 where --CohortName='Cohort20180712' and
  ([SurgicalProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  and [SurgicalProcedureDateTime]<= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  )
  and (TargetCode.ICD9Proc_code_type is not null or ICD10CodeList.ICD10Proc_code_type is not null)
go
...
select pat.patientssn,a.sta3n,a.patientsid	,a.SurgicalProcedureDateTime
			  ,DimICD9Proc.[ICD9ProcedureCode],TargetCode.ICD9ProcCode,TargetCode.ICD9Proc_Code_Type
    			,DimICD10Proc.ICD10ProcedureCode,ICD10CodeList.ICD10ProcCode,ICD10CodeList.ICD10Proc_Code_Type
into #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_3_HLP_CensusSurgICD_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
...
select pat.patientssn,a.sta3n,b.patientsid	,b.[TreatmentFromDateTime]
			  ,DimICD9Proc.[ICD9ProcedureCode],TargetCode.ICD9ProcCode,TargetCode.ICD9Proc_Code_Type
    			,DimICD10Proc.ICD10ProcedureCode,ICD10CodeList.ICD10ProcCode,ICD10CodeList.ICD10Proc_Code_Type
into #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_4_HLP_FeeICDProc_Inpat_ICD9ProcICD10Proc    --altered (ORD_...Dflt)
...
where --a.CohortName='Cohort20180712' and b.CohortName='Cohort20180712' and
  ([TreatmentFromDateTime] >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  and [TreatmentFromDateTime]<= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  )
   and (TargetCode.ICD9Proc_code_type is not null or ICD10CodeList.ICD10Proc_code_type is not null)
 go
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc    --altered (ORD_...Dflt)
;	
select patientssn
      ,[sta3n]
      ,[patientsid]
    ...
    into #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc	    --altered (ORD_...Dflt)
	from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	...
	from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_1_HLP_CensusICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
	union
	select patientssn
      ,[sta3n]
	...
	from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_2_HLP_InPSurgICD_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
	union
	select patientssn
      ,[sta3n]
	...
	from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_3_HLP_CensusSurgICD_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
	union
	select patientssn
      ,[sta3n]
	 ...
	 from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_4_HLP_FeeICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
	where ICD9Proc_code_type is not null
...
select patientssn
      ...
      ,ICD10Proc_Code_Type
	  ,'Inp-InpICD'	  as datasource
into  #Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD10Proc    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_0_HLP_InPICDProc_Inpat_ICD9ProcICD10Proc]    --altered (ORD_...Dflt)
...
into  #Lung_Sta3n671_3_Exc_NonDx_4_PrevProc_Inpat_1_CPT    --altered (ORD_...Dflt)
...
inner join 
	(select CPT_code_type,CPTCode from  #Lung_Sta3n671_0_8_PrevProcCPTCodeExc    --altered (ORD_...Dflt)
	union
	select img_code_type,ImgCode as CPTCode from  #Lung_Sta3n671_0_2_0_LungImg    --altered (ORD_...Dflt)
	) as TargetCode
...
where  --CPTProc.CohortName='Cohort20180712' and
	 CPTProc.[CPTProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
	and CPTProc.[CPTProcedureDateTime] <= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
go



-- Outpatient CPT procedure
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_3_Exc_NonDx_5_PrevProc_Outpat') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_3_Exc_NonDx_5_PrevProc_Outpat    --altered (ORD_...Dflt)
;		
SELECT 
	p.patientSSN,
	VProc.[Sta3n]
...
into #Lung_Sta3n671_3_Exc_NonDx_5_PrevProc_Outpat    --altered (ORD_...Dflt)
...
where 
	--VProc.CohortName='Cohort20180712' and
	 [VProcedureDateTime] >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
	and [VProcedureDateTime] <= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
go
...
SELECT 
	  ...
	  ,p.patientSSN
into #Lung_Sta3n671_3_Exc_NonDx_6_PrevProc_surg    --altered (ORD_...Dflt)
FROM [CDWWork].[Surg].[SurgeryPre] as surgPre    --altered (ORD_...Src)
  inner join #Lung_Sta3n671_1_In_8_IncPat as p    --altered (ORD_...Dflt)
  on SurgPre.sta3n=p.sta3n and SurgPre.patientsid=p.patientsid
  left join[CDWWork].[Surg].[SurgeryProcedureDiagnosisCode]as surgDx    --altered (ORD_...Src)
  ...
  on assocProc.OtherProcedureCPTSID=OtherCPT.CPTSID and assocProc.sta3n=OtherCPT.sta3n 
   where  
    SurgPre.[SurgeryDateTime] >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  and SurgPre.[SurgeryDateTime] <= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  ...
  and (
		  ...
		  (select CPTCode from  #Lung_Sta3n671_0_8_PrevProcCPTCodeExc    --altered (ORD_...Dflt)
			union
			select ImgCode as CPTCode from  #Lung_Sta3n671_0_2_0_LungImg)					     --altered (ORD_...Dflt)
...
SELECT  
	...
	,CPT_code_type
into #Lung_Sta3n671_3_Exc_NonDx_7_PrevProc_FeeServiceProvidedCPT    --altered (ORD_...Dflt)
FROM [CDWWork].[Fee].[FeeServiceProvided] as a    --altered (ORD_...Src)
inner join [CDWWork].[Fee].[FeeInitialTreatment] as d    --altered (ORD_...Src)
	on a.FeeInitialTreatmentSID=d.FeeInitialTreatmentSID
inner join cdwwork.dim.CPT as DimCPT
...
where --a.CohortName='Cohort20180712'  and d.CohortName='Cohort20180712' and
     InitialTreatmentDateTime >= DateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
  and InitialTreatmentDateTime <= DateAdd(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
go	
...
into  #Lung_Sta3n671_3_Exc_NonDx_8_PrevProc_AllNonDxProcICD9ICD10Proc_LungBiopsy    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc]    --altered (ORD_...Dflt)
...
from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD10Proc]    --altered (ORD_...Dflt)
		where [Proc_dt] is not null		
...
from [#Lung_Sta3n671_3_Exc_NonDx_4_PrevProc_Inpat_1_CPT]    --altered (ORD_...Dflt)
...
from [#Lung_Sta3n671_3_Exc_NonDx_5_PrevProc_Outpat]    --altered (ORD_...Dflt)
...
from #Lung_Sta3n671_3_Exc_NonDx_6_PrevProc_surg     --altered (ORD_...Dflt)
		where isnull([PrincipalProcedureCode],'') in (select cptcode from #Lung_Sta3n671_0_8_PrevProcCPTCodeExc    --altered (ORD_...Dflt)
...
from #Lung_Sta3n671_3_Exc_NonDx_6_PrevProc_surg     --altered (ORD_...Dflt)
		where isnull(OtherProcedureCode,'') in (select cptcode from #Lung_Sta3n671_0_8_PrevProcCPTCodeExc     --altered (ORD_...Dflt)
													  where cpt_code_type='LungBiopsy')
union
...
from [#Lung_Sta3n671_3_Exc_NonDx_7_PrevProc_FeeServiceProvidedCPT]    --altered (ORD_...Dflt)
...
into  #Lung_Sta3n671_3_Exc_NonDx_9_PrevProc_AllNonDxProcICD9ICD10Proc_Bronchoscopy    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc]    --altered (ORD_...Dflt)
		where [Proc_dt] is not null
...
into  #Lung_Sta3n671_3_Exc_NonDx_A_PrevProc_AllNonDxProcICD9ICD10Proc_LungSurgery    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_3_Exc_NonDx_3_PrevProc_Inpat_0_UnionAllInpICD9Proc]    --altered (ORD_...Dflt)
		where [Proc_dt] is not null
...
into  #Lung_Sta3n671_3_Exc_NonDx_E_PrevProc_AllNonDxProcICD9ICD10Proc_XRay    --altered (ORD_...Dflt)
--union
--from [#Lung_Sta3n671_3_Exc_NonDx_4_PrevProc_Inpat_1_CPT]    --altered (ORD_...Dflt)
--		where [CPTProcedureDateTime] is not null
...
into  #Lung_Sta3n671_3_Exc_NonDx_F_PrevProc_AllNonDxProcICD9ICD10Proc_CT    --altered (ORD_...Dflt)
--union
...
into  #Lung_Sta3n671_3_Exc_NonDx_G_PrevProc_AllNonDxProcICD9ICD10Proc_PET    --altered (ORD_...Dflt)
--union
...
into #Lung_Sta3n671_3_Ins_9_Ex_0_AllVisits_Hlp1					    --altered (ORD_...Dflt)
from [CDWWork].[Outpat].[Visit] as V    --altered (ORD_...Src)
inner join 
	(select distinct pat.*,ins.ExamDateTime 
		from [#Lung_Sta3n671_1_In_8_IncPat] as pat    --altered (ORD_...Dflt)
		left join #Lung_Sta3n671_1_In_6_IncIns as ins    --altered (ORD_...Dflt)
	...
	and v.VisitDateTime between dateAdd(yy,-1,p.ExamDateTime)
					and DateAdd(dd,30+(select fu_period from #Lung_Sta3n671_0_1_inputP),p.ExamDateTime)    --altered (ORD_...Dflt)
where 	--CohortName='Cohort20180712'	and	
	V.VisitDateTime between dateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
						and DateAdd(dd,30+(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))						      --altered (ORD_...Dflt)
go
...
into #Lung_Sta3n671_3_Ins_9_Ex_1_AllVisits    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_9_Ex_0_AllVisits_Hlp1    --altered (ORD_...Dflt)
   union
select PatientSSN,VisitSID,VisitDateTime,PrimaryStopCodeSID,SecondaryStopCodeSID
from #Lung_Sta3n671_3_Ins_9_Ex_0_AllVisits_Hlp1    --altered (ORD_...Dflt)
go
...
into #Lung_Sta3n671_3_Ins_9_Ex_1_AllVisits_StopCode    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_9_Ex_1_AllVisits as V    --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_3_Ins_9_Ex_2_VisitTIU') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_3_Ins_9_Ex_2_VisitTIU    --altered (ORD_...Dflt)
;

select v.*
	,T.[TIUDocumentSID],T.[EntryDateTime],T.[ReferenceDateTime]
	,e.tiustandardtitle,T.ConsultSID
into #Lung_Sta3n671_3_Ins_9_Ex_2_VisitTIU				    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_9_Ex_1_AllVisits_StopCode as V    --altered (ORD_...Dflt)
left join [CDWWork].[TIU].[TIUDocument] as T    --altered (ORD_...Src)
	on T.VisitSID=V.Visitsid AND T.Sta3n=671 --and T.CohortName='Cohort20180712'
					--more filter
					--and T.[EntryDateTime] between dateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
					--	and DateAdd(dd,30+(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))						      --altered (ORD_...Dflt)
...
into #Lung_Sta3n671_3_Ins_9_Ex_3_VisitTIUconsult_joinByConsultSID				    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_9_Ex_2_VisitTIU as V    --altered (ORD_...Dflt)
left join [CDWWork].[Con].[Consult] as C										                        --altered (ORD_...Src)
			on C.ConsultSID=V.ConsultSID --and CohortName='Cohort20180712'		
					--more filter
					--and C.[requestDateTime] between dateAdd(yy,-1,(select sp_start from #Lung_Sta3n671_0_1_inputP))    --altered (ORD_...Dflt)
					--	and DateAdd(dd,30+(select fu_period from #Lung_Sta3n671_0_1_inputP),(select sp_end from #Lung_Sta3n671_0_1_inputP))						      --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_3_Ins_0_1_In_4_Age') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_3_Ins_0_1_In_4_Age  ;  --altered (ORD_...Dflt)
select Rad.* 
into #Lung_Sta3n671_3_Ins_0_1_In_4_Age    --altered (ORD_...Dflt)
from #Lung_Sta3n671_1_In_6_IncIns as Rad    --altered (ORD_...Dflt)
where (DATEDIFF(yy,DOB,Rad.[ExamDateTime]) >= (select age from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_3_Ins_0_2_In_5_Alive') is not null)    --altered (ORD_...Dflt)
	drop table #Lung_Sta3n671_3_Ins_0_2_In_5_Alive    --altered (ORD_...Dflt)
;
select age.* into #Lung_Sta3n671_3_Ins_0_2_In_5_Alive    --altered (ORD_...Dflt)
 from #Lung_Sta3n671_3_Ins_0_1_In_4_Age as age      --altered (ORD_...Dflt)
 where 
        [DOD] is null 		
		or (DOD is not null 
				and ( 
					DATEADD(dd,-(select fu_period from #Lung_Sta3n671_0_1_inputP),dod)>age.ExamDateTime    --altered (ORD_...Dflt)
					)
				)	   	     
go
...
;
select a.*
into #Lung_Sta3n671_3_Ins_1_Ex_LungCancer    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_0_2_In_5_Alive as a    --altered (ORD_...Dflt)
where not exists
	(select * from #Lung_Sta3n671_2_Ex_7_ProblemListLC_Dx_ICD9ICD10 as b    --altered (ORD_...Dflt)
...
select *
into [#Lung_Sta3n671_3_Ins_2_Ex_Termi_Major]    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_1_Ex_LungCancer as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_2_Ex_4_UnionAllDx_ICD9ICD10] as b    --altered (ORD_...Dflt)
				where a.[PatientSSN] = b.[PatientSSN] and b.dx_code_type='Terminal' and 
			 (b.dx_dt between DATEADD(yy,-1,a.[ExamDateTime]) and DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP]),a.[ExamDateTime])))    --altered (ORD_...Dflt)
go
...
select *
into #Lung_Sta3n671_3_Ins_3_Ex_Hospi_1_ByDx    --altered (ORD_...Dflt)
from [#Lung_Sta3n671_3_Ins_2_Ex_Termi_Major] as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_2_Ex_4_UnionAllDx_ICD9ICD10] as b    --altered (ORD_...Dflt)
			 where a.[PatientSSN] = b.[PatientSSN] and b.dx_code_type='Hospice'  and 
			 b.dx_dt between DATEADD(yy,-1,a.[ExamDateTime] ) and 
			 DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP]),a.[ExamDateTime]))		    --altered (ORD_...Dflt)
go
...
select * 
into #Lung_Sta3n671_3_Ins_3_Ex_Hospi_2_Fee    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_3_Ex_Hospi_1_ByDx    --altered (ORD_...Dflt)
	except
SELECT x.*
from #Lung_Sta3n671_3_Ins_3_Ex_Hospi_1_ByDx as x    --altered (ORD_...Dflt)
inner join #Lung_Sta3n671_1_In_8_IncPat as p    --altered (ORD_...Dflt)
...
where ltrim(rtrim(b.AustinCode)) in ('43','37','38','77','78')   and
	   a.TreatmentFromDateTime 		between DATEADD(yy,-1,x.ExamDateTime) and 
					  DATEADD(dd,(select fu_period from #Lung_Sta3n671_0_1_inputP),x.ExamDateTime)    --altered (ORD_...Dflt)
go
...
;
select * 
into #Lung_Sta3n671_3_Ins_3_Ex_Hospi_3_ByPTF    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_3_Ex_Hospi_2_Fee    --altered (ORD_...Dflt)
	except
SELECT x.*
from #Lung_Sta3n671_3_Ins_3_Ex_Hospi_2_Fee as x    --altered (ORD_...Dflt)
inner join #Lung_Sta3n671_1_In_8_IncPat as p    --altered (ORD_...Dflt)
	 on  x.PatientSSN=p.PatientSSN
...
select *
into #Lung_Sta3n671_3_Ins_3_Ex_Hospi_3_Refer_joinByConsultSID    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_3_Ex_Hospi_3_ByPTF as a    --altered (ORD_...Dflt)
where not exists
			(	select * from [#Lung_Sta3n671_3_Ins_9_Ex_3_VisitTIUconsult_joinByConsultSID] as b    --altered (ORD_...Dflt)
				 where (
						 --With Stopcode
				 ...
				 and (coalesce(b.ReferenceDateTime,b.visitdatetime) between DATEADD(yy,-1, convert(varchar(10),a.ExamDateTime,120)+cast('00:00:00.000' as datetime)) 
								and DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP]), convert(varchar(10),a.ExamDateTime,120)+cast('23:59:59.997' as datetime)))    --altered (ORD_...Dflt)
				 and (datediff(dd,b.visitDateTime,isnull(b.ReferenceDateTime,b.visitDateTime))<(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
			         or datediff(dd,isnull(b.ReferenceDateTime,b.visitDateTime),b.visitDateTime)<(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
					  ) 
			)
...
select *
into #Lung_Sta3n671_3_Ins_4_Ex_Tuber    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_3_Ex_Hospi_3_Refer_joinByConsultSID as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_2_Ex_4_UnionAllDx_ICD9ICD10] as b    --altered (ORD_...Dflt)
...
;	
select *
into #Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_A_LungBiopsy    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_4_Ex_Tuber as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_3_Exc_NonDx_8_PrevProc_AllNonDxProcICD9ICD10Proc_LungBiopsy] as b    --altered (ORD_...Dflt)
			 where a.patientSSN = b.PatientSSN and
			 b.LungBiopsy_dt between DATEADD(dd,-(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
											,convert(varchar(10),a.ExamDateTime,120)+cast('00:00:00' as datetime)) 
						and DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
...
if (OBJECT_ID('[tempdb.dbo.#Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_B_Bronchoscopy]') is not null)    --altered (ORD_...Dflt)
	...
	;
select *
into #Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_B_Bronchoscopy    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_A_LungBiopsy as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_3_Exc_NonDx_9_PrevProc_AllNonDxProcICD9ICD10Proc_Bronchoscopy] as b    --altered (ORD_...Dflt)
			 where a.patientSSN = b.PatientSSN and
			 b.Bronchoscopy_dt between DATEADD(dd,-(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
											,convert(varchar(10),a.ExamDateTime,120)+cast('00:00:00' as datetime)) 
						and DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
											,convert(varchar(10),a.ExamDateTime,120)+cast('23:59:59:997' as datetime)))
go
...
;	
select *
into #Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_C_LungSurgery    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_B_Bronchoscopy as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_3_Exc_NonDx_A_PrevProc_AllNonDxProcICD9ICD10Proc_LungSurgery] as b    --altered (ORD_...Dflt)
			 where a.patientSSN = b.PatientSSN and
			 b.LungSurgery_dt between DATEADD(dd,-(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
											,convert(varchar(10),a.ExamDateTime,120)+cast('00:00:00' as datetime)) 
						and DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
											,convert(varchar(10),a.ExamDateTime,120)+cast('23:59:59:997' as datetime)))
...
;
select a.*
into  #Lung_Sta3n671_3_Ins_8_OutCome_Rep_Img_A_XRay    --altered (ORD_...Dflt)
from  [#Lung_Sta3n671_3_Ins_7_OutCome_Lung_Proc_C_LungSurgery] as a    --altered (ORD_...Dflt)
where not exists
			(select * from (select PatientSSN,ExamDateTime,img_code_type from [#Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN]     --altered (ORD_...Dflt)
						where [img_code_type]='XRay'
					 union  select patientssn, img_dt as ExamDateTime,code_type as img_code_type from  #Lung_Sta3n671_3_Exc_NonDx_E_PrevProc_AllNonDxProcICD9ICD10Proc_XRay    --altered (ORD_...Dflt)
						   where code_type='XRAY'
			   ) as b
			 where a.PatientSSN = b.patientSSN and			 
			 (b.ExamDateTime > a.examDateTime
					and	b.ExamDateTime<= DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
														,(convert(varchar(10),a.ExamDateTime,120)+cast('23:59:59.997' as datetime))))
...
;
select a.*
into  #Lung_Sta3n671_3_Ins_8_OutCome_Rep_Img_B_CT    --altered (ORD_...Dflt)
from  #Lung_Sta3n671_3_Ins_8_OutCome_Rep_Img_A_XRay as a    --altered (ORD_...Dflt)
where not exists
				(select * from (select PatientSSN,ExamDateTime,img_code_type from [#Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN]     --altered (ORD_...Dflt)
				       where [img_code_type]='CT'
					 union  select patientssn, img_dt as ExamDateTime,code_type as img_code_type from  #Lung_Sta3n671_3_Exc_NonDx_F_PrevProc_AllNonDxProcICD9ICD10Proc_CT    --altered (ORD_...Dflt)
						   where code_type='CT'
			   ) as b
			 where a.PatientSSN = b.patientSSN and			 
			 (b.ExamDateTime > a.ExamDateTime
...
;
select a.*
into  #Lung_Sta3n671_3_Ins_8_OutCome_Rep_Img_C_PET    --altered (ORD_...Dflt)
from  #Lung_Sta3n671_3_Ins_8_OutCome_Rep_Img_B_CT as a    --altered (ORD_...Dflt)
where not exists
				(select * from (select PatientSSN,ExamDateTime,img_code_type from [#Lung_Sta3n671_1_In_1_All_Chest_XRayCTPET_SSN]     --altered (ORD_...Dflt)
				where [img_code_type]='PET'
					 union  select patientssn, img_dt as ExamDateTime,code_type as img_code_type from  #Lung_Sta3n671_3_Exc_NonDx_G_PrevProc_AllNonDxProcICD9ICD10Proc_PET    --altered (ORD_...Dflt)
						   where code_type='PET'
			   ) as b
			 where a.PatientSSN = b.patientSSN and			 
			 (b.ExamDateTime > a.ExamDateTime
...
;				
select *
into #Lung_Sta3n671_3_Ins_D_OutCome_refer_1_pulm_joinByConsultSID    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_8_OutCome_Rep_Img_C_PET as a		    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_3_Ins_9_Ex_3_VisitTIUconsult_joinByConsultSID] as b    --altered (ORD_...Dflt)
			 where (
			 --With Stopcode
			 ...
			 -- There is a visit, but the StopCode is missing
				...
				and (coalesce(b.ReferenceDateTime,b.visitdatetime) between (convert(varchar(10),a.ExamDateTime,120)+cast('00:00:00.000' as datetime)) and 
					DATEADD(dd,(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
							, convert(varchar(10),a.ExamDateTime,120)+cast('23:59:59.997' as datetime)))
			    and (datediff(dd,b.visitDateTime,isnull(b.ReferenceDateTime,b.visitDateTime))<(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
			         or datediff(dd,isnull(b.ReferenceDateTime,b.visitDateTime),b.visitDateTime)<(select fu_period from [#Lung_Sta3n671_0_1_inputP])    --altered (ORD_...Dflt)
					))
...
;				
select *
into #Lung_Sta3n671_3_Ins_D_OutCome_refer_3_ThoracicSurgery_joinByConsultSID    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_D_OutCome_refer_1_pulm_joinByConsultSID as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_3_Ins_9_Ex_3_VisitTIUconsult_joinByConsultSID] as b    --altered (ORD_...Dflt)
			 where (
					 --With Stopcode
...
;				
select *
into #Lung_Sta3n671_3_Ins_D_OutCome_refer_4_TumorBoard_joinByConsultSID    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_D_OutCome_refer_3_ThoracicSurgery_joinByConsultSID as a    --altered (ORD_...Dflt)
where not exists
			(select * from [#Lung_Sta3n671_3_Ins_9_Ex_3_VisitTIUconsult_joinByConsultSID] as b    --altered (ORD_...Dflt)
			 where  (
...
;
	select distinct * 
	into #Lung_Sta3n671_3_Ins_U_TriggerPos    --altered (ORD_...Dflt)
	from [#Lung_Sta3n671_3_Ins_D_OutCome_refer_4_TumorBoard_joinByConsultSID]    --altered (ORD_...Dflt)
go		--6 rows
--  First instance in the study period in case of multiple trigger position instances, 
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_3_Ins_V_TriggerPos_FirstOfPat_SP') is not null)    --altered (ORD_...Dflt)
			drop table #Lung_Sta3n671_3_Ins_V_TriggerPos_FirstOfPat_SP    --altered (ORD_...Dflt)
go

select *
into #Lung_Sta3n671_3_Ins_V_TriggerPos_FirstOfPat_SP    --altered (ORD_...Dflt)
from #Lung_Sta3n671_3_Ins_U_TriggerPos as a    --altered (ORD_...Dflt)
where not exists
			(select *
			 from #Lung_Sta3n671_3_Ins_U_TriggerPos as b    --altered (ORD_...Dflt)
			 where a.PatientSSN = b.patientSSN and			 
			 b.ExamDateTime < a.ExamDateTime)
		and a.[ExamDateTime] between (select sp_start from #Lung_Sta3n671_0_1_inputP)     --altered (ORD_...Dflt)
							and (select sp_end from #Lung_Sta3n671_0_1_inputP)     --altered (ORD_...Dflt)
...
if (OBJECT_ID('tempdb.dbo.#Lung_Sta3n671_4_01_Count') is not null)    --altered (ORD_...Dflt)
			drop table #Lung_Sta3n671_4_01_Count    --altered (ORD_...Dflt)
go
		...
		NumOfTotalChestXRayCT (sta3n,sta6a,[Year],[Month],NumOfTotalChestXRayCT) as 	 
			(select  sta3n,sta6a,datepart(year,ExamDateTime) as [Year],datepart(MONTH,ExamDateTime) as[Month],count(distinct  RadiologyExamSID ) as NumOfTotalChestXRayCT
				 from #Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a    --altered (ORD_...Dflt)
				 where ExamDateTime >=(select sp_start from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
					   and ExamDateTime <=(select sp_end from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
		...
		,NumOfRedFlaggedChestXRayCT(sta3n,sta6a,[Year],[Month],NumOfRedFlaggedChestXRayCT) as 
				...
				from #Lung_Sta3n671_1_In_3_RedFlagXRayCT    --altered (ORD_...Dflt)
					 where ExamDateTime >=(select sp_start from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
						   and ExamDateTime <=(select sp_end from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
				group by sta3n,sta6a,datepart(year,ExamDateTime),datepart(MONTH,ExamDateTime)
			)
		...
		,NumOfTriggerPosChestXRayCT(sta3n,sta6a,[Year],[Month],NumOfTriggerPosChestXRayCT) as
			(select sta3n,sta6a,datepart(year,ExamDateTime) as [Year],datepart(MONTH,ExamDateTime) as[Month],count(distinct  RadiologyExamSID ) as NumOfTriggerPosChestXRayCT
				from #Lung_Sta3n671_3_Ins_U_TriggerPos    --altered (ORD_...Dflt)
					where ExamDateTime >=(select sp_start from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
						 and ExamDateTime <=(select sp_end from #Lung_Sta3n671_0_1_inputP)    --altered (ORD_...Dflt)
					group by sta3n,sta6a,datepart(year,ExamDateTime),datepart(MONTH,ExamDateTime)
			)
		...
		,NumOfTriggerPosPat(sta3n,sta6a,[Year],[Month],NumOfTriggerPosPat) as 
			...
			select 
					(select  run_dt  from #Lung_Sta3n671_0_1_inputP) as run_dt    --altered (ORD_...Dflt)
					,(select  sp_start from #Lung_Sta3n671_0_1_inputP) as sp_start    --altered (ORD_...Dflt)
					,(select  sp_end from #Lung_Sta3n671_0_1_inputP) as sp_end    --altered (ORD_...Dflt)
			...
			into #Lung_Sta3n671_4_01_Count    --altered (ORD_...Dflt)
...
select * from #Lung_Sta3n671_4_01_Count    --altered (ORD_...Dflt)
order by sta3n,sta6a,[year],[month]

---- data set:  Chest XRay/CT performed
----select * from #Lung_Sta3n671_1_In_2_All_Chest_XRayCT_Sta6a    --altered (ORD_...Dflt)

------ data set:  Chest XRay/CT which are red-flaged
/*FOR TEAM*/
--select P.PatientName,A.PatientSSN,A.DOB,A.DOD,A.Sex,P.VeteranFlag,A.RadiologyPatientIEN,A.CaseNumber,A.RequestedDateTime
--,A.ExamDateTime,A.RadiologyRegisteredExamIEN,A.RadiologyExamIEN,A.CPTCode,A.img_code_type,A.RadiologyExamStatus
--,A.ExamCategory,A.RadiologyDiagnosticCode,A.RadiologyDiagnosticCodeDescription,A.ClinicStopRecordedFlag 
--from #Lung_Sta3n671_1_In_3_RedFlagXRayCT as A    --altered (ORD_...Dflt)
...
/*FOR TEAM*/
--select P.PatientName,A.PatientSSN,A.DOB,A.DOD,A.Sex,P.VeteranFlag,RadiologyPatientIEN,A.RequestedDateTime
--,A.RadiologyRegisteredExamIEN,A.RadiologyExamIEN,A.CaseNumber,A.ExamDateTime,A.CPTCode,A.RadiologyExamStatus
--,A.ExamCategory,A.RadiologyDiagnosticCode,A.RadiologyDiagnosticCodeDescription,A.ClinicStopRecordedFlag
--from #Lung_Sta3n671_3_Ins_U_TriggerPos AS A    --altered (ORD_...Dflt)
--INNER JOIN CDWWork.SPatient.SPatient AS P on A.PatientSID = P.PatientSID
--WHERE P.Sta3n=671
